package gadget.util
{
	...
	public class PDFUtil extends CustomPurePDF
	{
		...
		private static function step2(entity:String, subtype:int, item:Object, create:Boolean, errorMessage:Function, bytes:ByteArray = null, width:int = 0, height:int = 0):void {
			...
			if(entity == 'Activity' && subtype == 1) {
				...
				generalPDF(entity, subtype, item, create, errorMessage, bytes, width, height);
			}
			
		}
		
		private static function generalPDF(entity:String, subtype:int, item:Object, create:Boolean, errorMessage:Function, bytes:ByteArray = null, width:int = 0, height:int = 0):void {
				...
				if(fields[i].column_name.indexOf(CustomLayout.NEWS_CODE) != -1 ){
					...
					if(fields[i].column_name.indexOf(CustomLayout.SQLLIST_CODE) != -1 ){
						...
						if(objectCustomField){
							...
							var result:String = Evaluator.evaluate(objectCustomField.value,ownerUser,null,null,item);
		...
		public static function detailToPDF(entity:String, subtype:int, item:Object, create:Boolean, errorMessage:Function):void {
			...
			if (!StringUtils.isEmpty(pdfLogo)) {
				...
				loader.contentLoaderInfo.addEventListener(Event.COMPLETE, function(e:Event):void {
					step2(entity, subtype, item, create, errorMessage, bytes, e.target.width, e.target.height);
				});
				loader.loadBytes(bytes);
			} else {
				step2(entity, subtype, item, create, errorMessage);
			}
		}
		...
		private static function stepView(strDay:String,dataSource:Array,image:ByteArray, errorMessage:Function,xmlRoute:Array,allAddress:Array, bytes:ByteArray = null, width:int = 0, height:int = 0):void {
			...
			dataColumns.push(getObjectColumn("conFirstName",i18n._("Contact First Name")));
			dataColumns.push(getObjectColumn("conLastName",i18n._("Contact Last Name")));
			dataColumns.push(getObjectColumn("conCellularPhone",i18n._("Contact Mobile Phone #")));
