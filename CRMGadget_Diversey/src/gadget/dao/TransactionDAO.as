	...
	public class TransactionDAO extends BaseSQL {
		...
		public function TransactionDAO(sqlConnection:SQLConnection) {
			...
			stmtInsert.text = "INSERT INTO transactions (entity, enabled, display_name,display, filter_id, default_filter, sync_ws20, sync_activities, sync_attachments, rank, read_only, "+
				...
				", advanced_filter ) VALUES (:entity, :enabled, :display_name,:display, :filter_id, :default_filter, :sync_ws20, :sync_activities, :sync_attachments, :rank, :read_only, " +
				...
				",:authorize_deletion_disable,:advanced_filter)";
			...
			stmtUpdate.text = "UPDATE transactions SET enabled = :enabled, display_name = :display_name,display = :display, filter_id = :filter_id, sync_ws20 = :sync_ws20, sync_activities = :sync_activities, sync_attachments = :sync_attachments, read_only = :read_only, rank = :rank" +
				",authorize_deletion = :authorize_deletion,advanced_filter = :advanced_filter WHERE entity = :entity";
			...
			stmtUpdateAllField.text = "UPDATE transactions SET enabled = :enabled, display_name = :display_name, display = :display, filter_id = :filter_id, default_filter = :default_filter, rank = :rank,"+ 
				...
				" filter_disable = :filter_disable, read_only_disable = :read_only_disable, sync_activities_disable = :sync_activities_disable, sync_attachments_disable = :sync_attachments_disable, entity_disable = :entity_disable, advanced_filter =:advanced_filter " + 
				" WHERE entity = :entity";
		...
		public var advancedfilter:ArrayCollection = new ArrayCollection([
			{type:ALL_TYPE,				name:"Show All"},
			{type:ONE_YEAR_TYPE,		name:"One Year"},
			{type:SIX_MONTH_TYPE,		name:"6 Month"},
			{type:THREE_MONTH_TYPE,		name:"3 Month"},
			{type:ONE_MONTH_TYPE,		name:"1 Month"},
			{type:SEVEN_DAY_TYPE,		name:"7 Days"}
		]);
		...
		public function getTransactionViewMode(entity:String):String {
			...
			if(entity == Database.customObject1Dao.entity || entity == Database.customObject2Dao.entity){
				return "Broadest";
			}
