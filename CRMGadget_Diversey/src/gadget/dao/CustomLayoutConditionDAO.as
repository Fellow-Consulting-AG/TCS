package gadget.dao
{
	...
	public class CustomLayoutConditionDAO{
		...
		public function CustomLayoutConditionDAO(sqlConnection:SQLConnection){
		...
		public function insert(customLayoutCondition:Object):void{
		...
		public function update(customLayoutCondition:Object):void{
