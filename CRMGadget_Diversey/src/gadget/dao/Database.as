	...
	public class Database extends BaseSQL {
		...
		private const PREFERENCE_FIELDS:ArrayCollection = new ArrayCollection(
			[{field:"sodhost", value:""}, {field:"sodlogin", value:""},
				...
				{field:PreferencesDAO.SYNC_ROLE_SERVICE, value: true},
				{field:PreferencesDAO.SYNC_ACCESS_PROFIL, value: true},
		...
		private function Istart(params:Object):void {
			...
			_customLayoutDao = new CustomLayoutDAO(_sqlConnection);
			...
			_customLayoutConditionDAO = new CustomLayoutConditionDAO(_sqlConnection);
		...
		private function XcheckDefaultEntries(sqlConnection:SQLConnection):void {
			_work("Checking default entries...", function(params:Object):void {
				...
				*/
				...
				YcheckCustomLayout("Activity", "activityTaskDefault", "Task", "Tasks", 0, [{column_name:'Activity', operator:'!=', params:'Appointment'}]);
		...
		public static function ycheckMissingField():void{
			if(database._fieldDao.findFieldByPrimaryKey("Activity", "Owner")==null){
				database._fieldDao.insert({entity:"Activity", element_name:"Owner", display_name:i18n._("Owner"), data_type:"Picklist"});
			}
			if(database._fieldDao.findFieldByPrimaryKey("Activity", "Address")==null){
				database._fieldDao.insert({entity:"Activity", element_name:"Address", display_name:'Address', data_type:"Picklist"});
			}
			if(database._fieldDao.findFieldByPrimaryKey("Activity", "IsPrivateEvent")==null){
				database._fieldDao.insert({entity:"Activity", element_name:"IsPrivateEvent", display_name:'Private Event', data_type:"BOOLEAN"});
			}
			...
			if(database._fieldDao.findFieldByPrimaryKey("Contact", "ms_change_key")==null){
				database._fieldDao.insert({entity:"Contact", element_name:"ms_change_key", display_name:'Microsoft Change Key', data_type:"TEXT"});
			}
			if(database._fieldDao.findFieldByPrimaryKey("Contact", "ms_id")==null){
				database._fieldDao.insert({entity:"Contact", element_name:"ms_id", display_name:'Microsoft Change Id', data_type:"TEXT"});
			}
			if(database._fieldDao.findFieldByPrimaryKey("Activity", "ms_change_key")==null){
				database._fieldDao.insert({entity:"Activity", element_name:"ms_change_key", display_name:'Microsoft Change Key', data_type:"TEXT"});
			}
			if(database._fieldDao.findFieldByPrimaryKey("Activity", "ms_id")==null){
				database._fieldDao.insert({entity:"Activity", element_name:"ms_id", display_name:'Microsoft Change Id', data_type:"TEXT"});
			}
			if(database._fieldDao.findFieldByPrimaryKey("Activity", "ms_local_change")==null){
				database._fieldDao.insert({entity:"Activity", element_name:"ms_local_change", display_name:'Microsoft Local Change', data_type:"TEXT"});
			}
		}
...
//				exec(stmt);
		...
		private function XfixLastSync(sqlConnection: SQLConnection):void {
			_work("Fixing Last Sync table...", function(params:Object):void {
				var stmt:SQLStatement = new SQLStatement();
				stmt.sqlConnection = sqlConnection;	
				stmt.text = "DELETE FROM last_sync WHERE task_name NOT LIKE 'gadget.sync.incoming%'" +
		...
		private static const TRANSACTIONS:Array = [
			...
			{entity:"Opportunity",sync_order:5, rank:5, enabled:true, filter:[
			...
			{entity:"CustomObject4",sync_order:14, rank:11},
			{entity:"CustomObject5",sync_order:15, rank:11},
			{entity:"CustomObject6",sync_order:16, rank:11},
			{entity:"CustomObject8",sync_order:17, rank:11},
			{entity:"CustomObject9",sync_order:18, rank:11},
			{entity:"CustomObject10",sync_order:19, rank:11},
			{entity:"Asset",sync_order:7, rank:13},
			{entity:"Territory",sync_order:14, rank:20},
			{entity:"Note",sync_order:21, rank:21},
			{entity:"MedEdEvent",sync_order:23, rank:22}
			
		];
		
		private static const SUB_TRANSACTIONS:Array = [
			{entity:"Account",sub:[{name:"Activity",sodname:"Activity",enabled:0},
				{name:"Attachment",sodname:"Attachment",enabled:0},
				{name:"AccountTeam",sodname:"Team",enabled:0},
				{name:"Partner",sodname:"Partner",enabled:0},
				{name:"Competitor",sodname:"Competitor",enabled:0},
				{name:"Asset",sodname:"Asset",enabled:0},
				{name:"Note",sodname:"Note",enabled:0}]},
			{entity:"Activity",sub:[{name:"Attachment",sodname:"Attachment",enabled:0}]},			
			{entity:"Campaign",sub:[{name:"Activity",sodname:"Activity",enabled:0},
				{name:"Attachment",sodname:"Attachment",enabled:0},
				{name:"Note",sodname:"Note",enabled:0}]},
			{entity:"Contact",sub:[{name:"Activity",sodname:"Activity",enabled:0},
				{name:"Attachment",sodname:"Attachment",enabled:0},
				{name:"ContactTeam",sodname:"Team",enabled:0},
				{name:"Note",sodname:"Note",enabled:0},
				{name:"Contact Relationships",sodname:"Related",enabled:0}]},
			{entity:"Custom Object 1",sub:[{name:"Attachment",sodname:"Attachment",enabled:0}]},
			{entity:"Lead",sub:[{name:"Activity",sodname:"Activity",enabled:0},
				{name:"Attachment",sodname:"Attachment",enabled:0}]},
			{entity:"Opportunity",sub:[{name:"Activity",sodname:"Activity",enabled:0},
				{name:"Attachment",sodname:"Attachment",enabled:0},
				{name:"Opportunity Team",sodname:"Team",enabled:0},
				{name:"Opportunity Partner",sodname:"Partner",enabled:0},
				{name:"Opportunity Product Revenue",sodname:"Product",enabled:0},				
				{name:"Note",sodname:"Note",enabled:0}]},
			//{entity:"Product",sub:[{name:"Activity",enabled:0},{name:"Attachment",enabled:0}]},
			{entity:"Service Request",sub:[{name:"Attachment",sodname:"Attachment",enabled:0},{name:"Note",sodname:"Note",enabled:0}]},
			{entity:"Custom Object 2",sub:[{name:"Activity",sodname:"Activity",enabled:0},{name:"Attachment",sodname:"Attachment",enabled:0}]},
			{entity:"Custom Object 3",sub:[{name:"Attachment",sodname:"Attachment",enabled:0}]},
			{entity:"CustomObject14",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject7",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject4",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject5",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject6",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject8",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject9",sub:[{name:"Activity",sodname:"Activity",enabled:0}]},
			{entity:"CustomObject10",sub:[{name:"Activity",sodname:"Activity",enabled:0}]}
		...
		private function YcheckDefaultFilter():void {
			var stdFilters:Array = [
				...
				{type:Database.FAVORITE, name:'Favorite'},
				{type:Database.IMPORTANT, name:'Important'}
			];
