package gadget.dao
{
	...
	public class PicklistDAO extends BaseSQL {
		...
		public function PicklistDAO(sqlConnection:SQLConnection)
		{
			...
			stmtSelect.text = "SELECT code data, value label FROM picklist WHERE record_type = :record_type AND field_name = :field_name AND disabled = :disabled ORDER BY Order_";
