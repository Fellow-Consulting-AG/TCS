package gadget.dao
{
	...
	public class CustomLayoutDAO extends BaseSQL {
		...
		public function CustomLayoutDAO(sqlConnection:SQLConnection)
		{
		...
		public function insert(layout:Object):void
		{
			executeStatement(stmtInsert,layout);
		}
		
		public function update(layout:Object):void
		{
...
//			stmt.parameters[":value"] = layout.value;
		...
		public function delete_(entity:String, subtype:int):void{
			var cache:CacheUtils = new CacheUtils("Custom_Layout");
			var key:String = entity + "_" + subtype;
			cache.del(key);
			...
			if (customLayout != null) {
				...
				if (customLayout.display_name == null || customLayout.display_name == '') {
					...
					if(entity == 'Activity'){
						...
						if(obj==null){
							objName = i18n._("GLOBAL_" + entity.replace(/\s/gi,"_").toUpperCase());
						}else{
