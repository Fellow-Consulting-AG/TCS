package gadget.dao{
	...
	public class CustomObject1DAO  extends BaseDAO {
...
*/		
		...
		public function getWorkingHoursAndCost(srItem:Object):ArrayCollection {
			return findAll(COLUMN_WORKING_HOURS_AND_COST, "ServiceRequestId='"+srItem.ServiceRequestId+"'");
		}
		
		private var COLUMN_WORKING_HOURS_AND_COST:ArrayCollection = new ArrayCollection([
			{element_name:'IndexedNumber0'},
			{element_name:'IndexedPick0'},
			{element_name:'IndexedPick1'},
			{element_name:'IndexedPick2'},
			{element_name:'CustomPickList0'},
			{element_name:'QuickSearch1'},
			{element_name:'CustomInteger0'}
		]);
